...
float PCFCube(samplerCube shadowMapCube_1, vec3 lp, inout vec3 ml, float bias, vec2 lightProj_1, vec3 n)
{
    ...
    float _339 = lpToDepth(param, lightProj_1);
    float compare = _339 - (bias * 0.4000000059604644775390625);
...
void main()
{
    ...
    {
        _554 = octahedronWrap(g0.xy);
    }
    n = vec3(_554.x, _554.y, n.z);
    n = normalize(n);
    ...
    else
    {
        ...
        {
            vec3 param = -l;
            float _688 = PCFCube(shadowMapCube, lp, param, shadowsBias, lightProj, n);
            visibility = _688;
        }
    }
    ...
    vec3 _733 = lambertDiffuseBRDF(albedo, dotNL) + specularBRDF(f0, metrough.y, dotNL, dotNH, dotNV, dotVH);
    fragColor = vec4(_733.x, _733.y, _733.z, fragColor.w);
    vec3 _740 = fragColor.xyz * lightColor;
    fragColor = vec4(_740.x, _740.y, _740.z, fragColor.w);
    vec3 _746 = fragColor.xyz * visibility;
    fragColor = vec4(_746.x, _746.y, _746.z, fragColor.w);
}
